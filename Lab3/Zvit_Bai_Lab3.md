...
Необхідно розробити програму, що моделює роботу книжкового магазину.
...
ISBN: 978-0367575632 | Numerical Methods - Justin Solomon | Ціна: 1350.8 грн | Кількість: 4
ISBN: 978-3-030-56402-5 | Probability Theory - Achim Klenke | Ціна: 950.0 грн | Кількість: 1
ISBN: 978-1466367296 | Think Python - Allen Downey | Ціна: 1150.0 грн | Кількість: 2
```

- Тестування, що можна зареєструвати нового клієнта
```css
1. Додати товар
2. Зареєструвати клієнта
3. Купити книгу
...
[СПИСОК КЛІЄНТІВ]
Клієнт: John (ID: 003) | Історія покупок: Networks, Numerical Methods
Клієнт: Bob (ID: 007) | Історія покупок: Numerical Methods
Клієнт: Alice (ID: 006) | Історія покупок: Покупок немає
```
